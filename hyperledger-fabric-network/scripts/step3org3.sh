...
# on peer0.provider and peer0.consumer, and uprage the chaincode on the
...
echo "===================== Installing chaincode 2.0 on peer0.provider ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.consumer ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.provider ===================== "
